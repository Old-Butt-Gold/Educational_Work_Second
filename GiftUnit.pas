        ...
        Try
            Try
                ...
                Begin
                    ...
                    While Temp <> Nil do
                    Begin    
                        Str := Str + 'Тип сладости: ' + Temp.TypeofCandy + ' ' + 'Имя сладости: ' + Temp.Name + ' ' + 'Количество: ' + IntToStr(Temp.Count) + ' ' + 'Содержание сахара: ' + IntToStr(Temp.Sugar) + 'мг. ; ';
                        Temp := Temp^.Next;
                    End;
...
begin
    ...
    Begin
        ...
        Begin
            ...
            GiftNode.Text := Format('%s - Имя сладости: %s, Число: %d, Содержание сахара: %s', [GiftNode.Text, Temp^.Name, Temp^.Count, IntToStr(Temp^.Sugar) + 'мг']);
            Temp := Temp^.Next;
        End;
    End;
